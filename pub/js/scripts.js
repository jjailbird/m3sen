	...
	function FirstLoad() {	
		...
		$('.section-image').each(function() {
			...
			$(this).css({ 
				...
				'background': 'linear-gradient(rgba(10,10,10,.6), rgba(0,0,0,.9)), repeating-linear-gradient(0, transparent, transparent 2px, black 3px, black 3px),' + 'no-repeat center/cover url(' + image + ')',
			});
		});
